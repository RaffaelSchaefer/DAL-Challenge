...
migrate((db) => {
  ...
  collection.listRule = ""
  collection.viewRule = ""
  collection.createRule = "(id = @collection.customer_user.works_for && @collection.customer_user.isUser = @request.auth.id) || @collection.dla_user.isUser = @request.auth.id"
